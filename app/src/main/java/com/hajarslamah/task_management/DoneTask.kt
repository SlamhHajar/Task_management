 ...
 * Use the [DoneTask.newInstance] factory method to
...
class DoneTask : Fragment() {
    ...
    private var adapter: DoneTask.TaskAdapter? = TaskAdapter(emptyList())
    ...
    companion object {
         ...
         * @return A new instance of fragment DoneTask.
         */
